...
<html lang="pt-br">
    ...
    <?php
    $sql_resultado_consulta_turma = "SELECT * FROM turma WHERE nome_turma != '' ORDER BY nome_turma ASC";
        ...
        ?>
                            ...
                            <td>
                                <select name="professor">
                                    <?php
                                    $sql_resultado_consulta_professor = "SELECT * FROM professor WHERE nome_professor != '' ORDER BY nome_professor ASC";
    ...
    <?php } ?>
                            ...
                            <td>Data de Hoje:</td>
                            <td>
                                <input type="text" name="data_atual" value="<?php date_default_timezone_set("America/Sao_Paulo");
    echo date('d/m/Y'); ?>" style="width:80px" disabled>
                            </td>
                            <td>						
...
>>>>>>> 3abfb39761cda73774cf3413a17c5707c56a7136
</html>