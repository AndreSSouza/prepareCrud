...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <?php if (@$_GET['op'] == 'visualizar') { ?>
                    ...
                    <table width="900" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" disabled name="data_nascimento_professor" id="textfield3" value="<?php $dt_nasc_prof = date('Y-m-d', strtotime($dt_nasc_prof));
            echo $dt_nasc_prof; ?>">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <select disabled name="sexo_professor" size="1" id="">
                                    <option value="<?php echo $sexo_prof; ?>"><?php $mostra_sexo = strtolower($sexo_prof);
            echo ucfirst($mostra_sexo); ?></option>
                    ...
                    <form name="form1" method="post" action="">
                        <table width="900" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" name="data_nascimento_professor" id="textfield3" value="<?php $dt_nasc_prof = date('Y-m-d', strtotime($dt_nasc_prof));
                    echo $dt_nasc_prof; ?>">
                                </td>
                            </tr>
                            <tr>
    ...
    <?php
    $sql_select_professor = "SELECT * FROM professor WHERE nome_professor != ''";
    ...
    if (mysqli_num_rows($consulta_select_professor) == '') {
        ...
        <?php
        while ($resultado_consulta_select_professor = mysqli_fetch_assoc($consulta_select_professor)) {
...
<?php if (@$_GET['pg'] == 'disciplina') { ?>
    ...
    if (mysqli_num_rows($resultado_consulta_materia) == '') {
        ...
        ?>
                                            ...
                                            <?php
                                            while ($resultado_consulta_materia_valores = mysqli_fetch_assoc($resultado_consulta_materia)) {
...
<?php if (@$_GET['pg'] == 'disciplinas_ministradas') { ?>
                                        ...
                                        <?php
                                        $sql_select_consulta_disciplinas_ministradas = "SELECT * FROM disciplina_ministrada dm INNER JOIN disciplina d ON d.id_disciplina = dm.id_disciplina INNER JOIN professor p ON p.id_professor = dm.id_professor";
