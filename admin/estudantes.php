            ...
            <?php if (@$_GET['pg'] == 'espera') { ?>
                ...
                <?php if (@$_GET['mod'] == 'edita') { ?>
                    ...
                    if (isset($_POST['salvar'])) {
                        ...
                        $update_inscricao = $crud->update('inscricao', 'nome_aluno = :nome, sexo_aluno = :sexo, email = :email, telefone_responsavel = :telefone, celular_responsavel = :celular')->run([':nome' => $nome_post, ':sexo' => $sexo_post, ':email' => $email_post, ':telefone' => $telefone_post, ':celular' => $celular_post]);
                    ...
                    <form name="form1" method="post" action="">
                        <table width="900" border="0">
                            ...
                            <tr>
                                ...
                                //$sql_select_ultimo_cod_inscricao = "SELECT * FROM inscricao ORDER BY id_inscricao DESC LIMIT 1";
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td colspan="5">
                                                                                                                                            <br><i><center><b>Histórico de presenças</b></center></i><br>
                                                                                                                                                    ...
                                                                                                                                                    <?php
                                                                                                                                                    while ($val_chamada = mysqli_fetch_assoc($sql_chamada)) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    <tr>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <td>
                                                                                                                                                                                            <select name="sexoA" size="1" id="">
                                                                                                                                                                                                <option value="<?php echo $sexo_A; ?>"><?php
                                                                                                                                                                                            ...
                                                                                                                                                                                            <br><i><center><b>Informações pessoais do responsável</b></center></i><br>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <tr>							
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <td>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <option value="<?php echo $sexo_R; ?>"><?php
