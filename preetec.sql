...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Out-2018 às 20:39
...
(121, 1, 3, 1, '2018-09-13', 0),
(122, 1, 4, 1, '2018-09-13', 1),
(123, 1, 7, 1, '2018-09-13', 1),
(124, 1, 8, 1, '2018-09-13', 1),
(125, 1, 3, 1, '2018-09-24', 0),
(126, 1, 4, 1, '2018-09-24', 1),
(127, 1, 7, 1, '2018-09-24', 1),
(128, 1, 8, 1, '2018-09-24', 1),
(129, 1, 3, 1, '2018-09-25', 0),
(130, 1, 4, 1, '2018-09-25', 1),
(131, 1, 7, 1, '2018-09-25', 1),
(132, 1, 8, 1, '2018-09-25', 1),
(137, 1, 3, 1, '2018-10-04', 1),
(138, 1, 4, 1, '2018-10-04', 1),
(139, 1, 7, 1, '2018-10-04', 1),
(140, 1, 8, 1, '2018-10-04', 0),
(141, 1, 3, 1, '2018-10-08', 1),
(142, 1, 4, 1, '2018-10-08', 1),
(143, 1, 7, 1, '2018-10-08', 1),
(144, 1, 8, 1, '2018-10-08', 1),
(145, 2, 3, 1, '2018-10-08', 0),
(146, 1, 3, 1, '2018-10-09', 1),
(147, 1, 4, 1, '2018-10-09', 1),
(148, 1, 7, 1, '2018-10-09', 1),
(149, 1, 8, 1, '2018-10-09', 1),
(150, 2, 3, 1, '2018-10-09', 1),
(151, 1, 3, 1, '2018-10-18', 1),
(152, 1, 4, 1, '2018-10-18', 0),
(153, 1, 7, 1, '2018-10-18', 1),
(154, 1, 8, 1, '2018-10-18', 1);
...
(1, '2018-07-23 22:27:37', 'Fabio Puentes', 'MASCULINO', 'email@gmail.com', '1143434343', '11979797979', b'0'),
...
(7, '2018-10-18 03:56:10', 'Lucas RomÃ£o Gomes', 'MASCULINO', 'teste@teste.com.br', '1145245245', '11959595959', b'0');
...
(1, 'admin', '202cb962ac59075b964b07152d234b70', 'ADMINISTRADOR', 'ATIVO'),
(2, 'admin', '123', 'ADMINISTRADOR', 'ATIVO');
...
(3, 1, 2, 'POO em Java', 'linguagem de programacao orientada a objetos do Java'),
(4, 1, 2, 'Qualquer coisa', 'Vai entender\r\neu sla');
...
DROP TABLE IF EXISTS `sala_video`;
...
--
ALTER TABLE `chamada`
  MODIFY `id_chamada` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
...
--
ALTER TABLE `inscricao`
  MODIFY `id_inscricao` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `login`
--
ALTER TABLE `login`
  MODIFY `id_login` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `plano_aula`
  MODIFY `id_plano` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `reserva`
  MODIFY `id_reserva` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sala_video`
  MODIFY `id_sala` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `turma`
--
ALTER TABLE `turma`
  MODIFY `id_turma` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
